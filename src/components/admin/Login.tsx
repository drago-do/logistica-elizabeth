      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6" id="login-form">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-brand focus:border-transparent outline-none transition-all"
          ...
          <button
            id="login-submit"
            type="submit"
            className="w-full bg-brand hover:bg-brand-hover text-white font-semibold py-2.5 rounded-lg shadow-lg shadow-brand/20 transition-all active:scale-[0.98]"
          >
            Iniciar Sesión
          </button>
        </form>
